...
var HA =
	Eu(`<main><div class="popup-overlay svelte-1gdj0jn"><div class="popup svelte-1gdj0jn"><img class="warning-ico svelte-1gdj0jn" alt="warning-icon"> <p>Ồ không! Cục Dàng hãy xem trên máy tính để có trải nghiệm tốt
...
Oe.exports.create;
var mn = Eu(
	'<div class="birthday-calendar svelte-11rskz7"><div class="calendar-header svelte-11rskz7">Tháng 5</div> <div class="calendar-body svelte-11rskz7"><div class="calendar-date svelte-11rskz7">17</div> <div class="calendar-year svelte-11rskz7">2004</div></div></div>'
);
function hn(u) {
	var D = mn();
	Q(u, D);
...
function yn(u) {
	let D = au(!1),
		e =
			"Em à! Vậy là hành trình của chúng ta đã trôi qua được 4 tháng rồi. Có lẽ đến lúc này, em vẫn như là một phép màu xuất hiện trong cuộc đời anh. Cảm ơn em vì đã đến và yêu thương anh bằng tất cả những tình cảm đơn thuần nhất, tuy 4 tháng không phải lâu nhưng chúng ta đã có những kỷ niệm khó quên cũng như không ít lần tưởng chừng đã buông xuôi tất cả, nhưng thật may mắn sau tất cả chúng ta vẫn ở đây, vẫn yêu thương nhau như lúc đầu.\nVẫn mong chúng ta mạnh mẽ, vững tin, và yêu thương nhau nhiều hơn từng ngày để không những 4 tháng mà 4 năm hay thậm chí 40, 60 hay 80 năm nữa ta lại vẫn sẽ nói yêu nhau mỗi ngày, vẫn chúc nhau ngày mới vui vẻ, chúc nhau ngủ ngon mỗi tối, nói nhớ nhau mỗi khi xa...\nMong người anh yêu sẽ thành công trên con đường sắp tới, hãy nhớ rằng dù có thế nào thì anh vẫn phía sau bảo vệ cho em, giúp đỡ khi em cần, chờ em về nhà....Nhớ nha! ❤️\nCảm ơn em, yêu em - phép màu của anh! 😘😘",
		F = au(""),
		A = 0;
	async function C() {
...
function bn(u) {
	let D =
			"https://cover-talk.zadn.vn/e/0/7/d/7/36b2a4c71058ce13af891ec7fa16214a.jpg",
		e = "";
	var F = wn(),
		A = Au(F);
	zF(A, "src", D);
...
var Sn = Eu(
	'<section class="letter svelte-1cze7eq"><div class="flag svelte-1cze7eq"><img src="./assets/flag.png" alt="flag" class="svelte-1cze7eq"></div> <div class="content svelte-1cze7eq"><div class="content-text svelte-1cze7eq"><h1 class="custom-text svelte-1cze7eq">Happy 4 month anniversary</h1> <div class="group-birthday svelte-1cze7eq"><!></div> <!></div> <div class="content-image svelte-1cze7eq"><div class="circle svelte-1cze7eq"><!></div></div></div></section>'
);
function Mn(u) {
	var D = Sn(),
		e = fu(Au(D), 2),
...
var xn = Eu('<h1 class="typing">Xin chào Cục dàng của anh</h1>'),
	...
	Un = Eu("<main><!></main>");
function Gn(u) {
	let D = "Anh có điều nhỏ xíu này dành cho em!",
		e = au(!1);
	var F = Un(),
		A = Au(F);
	{
